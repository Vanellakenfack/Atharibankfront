...
const AgenceForm = () => {
  ...
  const [formData, setFormData] = useState({
    agence: '',
    derniereDateComptable: new Date(),
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert(`Agence ${formData.operation === 'OU' ? 'ouverte' : 'fermée'} avec succès !`);
      navigate('/');
    } catch (error) {
        ...
        <Box sx={{ px: { xs: 2, md: 4 }, py: 4 }}>
          <Box sx={{ mb: 4 }}>
            ...
            <Typography variant="body2" sx={{ color: '#64748B' }}>
              Gérer l'ouverture ou la fermeture des agences
            </Typography>
          </Box>
              ...
              <LocalizationProvider dateAdapter={AdapterDateFns} adapterLocale={fr}>
                <form onSubmit={handleSubmit}>
                  <Grid container spacing={3}>
                    ...
                    {/* Dernière Date comptable */}
                    <Grid item xs={12} md={6}>
                      <DatePicker
                        label="Dernière Date comptable"
                        value={formData.derniereDateComptable}
                        onChange={(date) => handleDateChange('derniereDateComptable', date)}
                    ...
                    <Grid item xs={12} md={6}>
                      <FormControl fullWidth size="small">
                        ...
                        >
                          <MenuItem value="FE">Fermée (FE)</MenuItem>
                          <MenuItem value="OU">Ouverte (OU)</MenuItem>
                        </Select>
                      </FormControl>
                    </Grid>
